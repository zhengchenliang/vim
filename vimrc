...
map fi :set nosplitbelow<CR>:split<CR>:set splitbelow<CR>
map fk :set splitbelow<CR>:split<CR>
map fj :set nosplitright<CR>:vsplit<CR>:set splitright<CR>
...
noremap fu <C-w>t<C-w>K
" Place the two screens side by side
noremap fh <C-w>t<C-w>H

" Rotate screens
noremap fdu <C-w>b<C-w>K
noremap fdh <C-w>b<C-w>H

" ===
" === Tab management
" ===
" Create a new tab with gn
map gn :tabe<CR>
" Move around tabs with gj and gl
map gj :-tabnext<CR>
map gl :+tabnext<CR>
" Move the tabs with gk and gi
map gk :-tabmove<CR>
map gi :+tabmove<CR>
...
" === Dress up my vim
" ===
"  map n1 :set background=dark<CR>:colorscheme snazzy<CR>:AirlineTheme dracula<CR>
"  map n2 :set background=light<CR>:colorscheme ayu<CR>:AirlineTheme ayu_light<CR>
